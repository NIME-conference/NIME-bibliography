...
# updated on 9/6/2024 by Stefano Fasciani to fix several SyntaxWarning
...
class AccentConverter:
    ...
    def __create_translation_rules(self):
        ...
        self.populate_encode_dict(encode_dict, strKey_dot, strValue_dot, r"{\\\.", "}")
        regex_detectors.append( re.compile(r"{ *\\\. *[a-zA-Z]{1} *}") )
